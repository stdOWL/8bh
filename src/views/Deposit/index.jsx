        ...
        <Layout title="Deposit">
          <Row className="deposit-box">
            <Col lg={4} className="qrcode">
              <QRCode value={selectedNetwork?.wallet || ''} size={275} eyeRadius={1} />
            </Col>
            <Col lg={8} className="deposit-info">
              ...
              <div className="address">
                <div>
                  <p>
                    Send any amount of Bitcoin to this address to fund your
                    account:
                  </p>
                  <span className="wallet"><strong>{selectedNetwork.wallet}</strong></span>
                </div>
